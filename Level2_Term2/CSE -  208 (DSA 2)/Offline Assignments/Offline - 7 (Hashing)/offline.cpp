...
int main()
{
    ...
    cout<<"size: "<<hash_size<<" method: Separate chaining Hash1 average probes: "<<(float)chain_hash.prob_count/1000<<"\n";

    cout<<"size: "<<hash_size<<" method: Double hashing Hash1 collision count: "<<probHash_doubleHash.dh_collisionCount<<"\n";
    cout<<"size: "<<hash_size<<" method: Double hashing Hash1 average probes: "<<(float)probHash_doubleHash.dh_probCount/1000<<"\n ";

    cout<<"size: "<<hash_size<<" method: Custom probing Hash1 collision count: "<<probHash_customProb.cp_collisionCount<<"\n";
    cout<<"size: "<<hash_size<<" method: Custom probing Hash1 average probes:  "<<(float)probHash_customProb.cp_probCount/1000<<"\n";
    ...
    cout<<"size: "<<hash_size<<" method: Separate chaining Hash1 average probes: "<<(float)chain_hash2.prob_count/1000<<"\n";

    cout<<"size: "<<hash_size<<" method: Double hashing Hash1 collision count: "<<probHash_doubleHash2.dh_collisionCount<<"\n";
    cout<<"size: "<<hash_size<<" method: Double hashing Hash1 average probes: "<<(float)probHash_doubleHash2.dh_probCount/1000<<"\n";

    cout<<"size: "<<hash_size<<" method: Custom probing Hash1 collision count: "<<probHash_customProb2.cp_collisionCount<<"\n";
    cout<<"size: "<<hash_size<<" method: Custom probing Hash1 average probes:  "<<(float)probHash_customProb2.cp_probCount/1000<<"\n";
    ...
    cout<<"size: "<<hash_size<<" method: Separate chaining Hash1 average probes: "<<(float)chain_hash3.prob_count/1000<<"\n";

    cout<<"size: "<<hash_size<<" method: Double hashing Hash1 collision count: "<<probHash_doubleHash3.dh_collisionCount<<"\n";
    cout<<"size: "<<hash_size<<" method: Double hashing Hash1 average probes: "<<(float)probHash_doubleHash3.dh_probCount/1000<<"\n";

    cout<<"size: "<<hash_size<<" method: Custom probing Hash1 collision count: "<<probHash_customProb3.cp_collisionCount<<"\n";
    cout<<"size: "<<hash_size<<" method: Custom probing Hash1 average probes:  "<<(float)probHash_customProb3.cp_probCount/1000<<"\n";
