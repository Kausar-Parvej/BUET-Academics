          ...
          <div className="text-on-image-u" style={{ marginTop: "20px" }}>
            ...
            <p>
              ...
              <h4>
                ...
                <p>and be the reason for someone's existence</p>{" "}
        ...
        <div>
          <HomeWrapper id="top_books">
            <Container>
              <div className="clearfix mt-5 mb-2 divBottom">
                <header>
                  <h3 className="float-left">{"Recent Posts"}</h3>
                </header>
              </div>
              <br></br>
        ...
        <div>
          <HomeWrapper id="recent_books">
            <Container>
              <div className="clearfix mt-5 mb-2 divBottom">
                <header>
                  <h3 className="float-left">Post : 1</h3>
                </header>
              </div>
              <br></br>
        ...
        <div>
          <HomeWrapper>
            <Container>
              <div className="clearfix mt-5 mb-2 divBottom">
                <header>
                  <h3 className="float-left">Post : 2</h3>
                </header>
              </div>
            </Container>
          </HomeWrapper>
        ...
        <div>
          <HomeWrapper>
            <Container>
              <div className="clearfix mt-5 mb-2">
                <h5 className="float-left">
                  <u>See the Posts You Commented</u>
                </h5>
                {/* <Link className="float-right text-uppercase" to="/">
              see all
              </Link> */}
