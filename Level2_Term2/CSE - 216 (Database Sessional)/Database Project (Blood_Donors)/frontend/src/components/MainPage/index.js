...
import Banner from "../../assets/images/LSlogo2.png";
...
export default function MainPage() {
  ...
  async function postUser(e) {
    ...
    if (
      ...
      toastFun(
        "Phone Number Must Not Exceed 14 Characters (Including Spaces)",
        2
      );
      return;
    }
    ...
    <div>
      ...
      <div className="head-text">
        ...
        <div className="text-on-image">
          <h1>
            {" "}
            <strong> Welcome to LifeStream </strong>{" "}
          </h1>
          <p></p>
          <p>
            <h4>
              {" "}
              <p>The Blood Donating Platfrom</p>
              <p>
                <br />
              </p>
              <div className="black">
                <p>
                  An innovative blood donation app <br />
                  which encourages, engages and motivates
                  <br />
          ...
          <p>
                ...
                <p>
                <a href="#User">
                <button type="button" class="btn btn-primary btn-lg">Get Started as User</button>
                </a>
                </p> 
                */}
        </div>
      ...
      <div class="container login-container" id="reader">
        <div class="col-lg-12 mbr-col-md-10">
          <div class="wrap">
            <div class="text-wrap vcenter">
              <h3 class="mbr-fonts-style mbr-bold mbr-section-title3 display-5">
                <i class="fas fa-book-reader"></i>User Section
              </h3>
            </div>
          </div>
        </div>
