      ...
      <Navbar bg="light" variant="light" fixed="top">
        <Container>
          ...
          <Nav className="navitem01 navbar-nav mr-auto">
            ...
            <Nav.Link href="/manage-books" style={{paddingLeft: "20px"}}><strong > Donors  </strong></Nav.Link>
            <Nav.Link href="/manage-authors" style={{paddingLeft: "20px"}}><strong > Patients  </strong></Nav.Link>
            <Nav.Link href="/manage-publishers" style={{paddingLeft: "20px"}}><strong > Blood Bank  </strong></Nav.Link>
            <Nav.Link href="/manage-genres" style={{paddingLeft: "20px"}}><strong > Blood Group  </strong></Nav.Link>
