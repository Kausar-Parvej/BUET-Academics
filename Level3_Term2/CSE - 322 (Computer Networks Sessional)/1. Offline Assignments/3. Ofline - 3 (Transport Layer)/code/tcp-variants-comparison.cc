...
main(int argc, char* argv[])
{
    ...
    std::string transport_prot = "TcpHtcpModified";  // First variant

    double error_p = 0.0;
    //std::string bandwidth = "2Mbps";
    std::string bandwidth = "3Mbps";         // As per 1+x%3
    ...
    uint16_t num_flows = 7;                  // As per (x^3)%7 + 1
    ...
    cmd.AddValue("transport_prot",
                 ...
                 "TcpHybla, TcpHighSpeed, TcpHtcp,TcpHtcpModified, TcpVegas, TcpScalable, TcpVeno, "
    ...
    /* don't need this file (for reducing disk space usage)
