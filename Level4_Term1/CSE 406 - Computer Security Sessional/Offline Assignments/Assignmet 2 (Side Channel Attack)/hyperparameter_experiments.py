...
def train_model_experiment(model, train_loader, test_loader, lr, epochs=20, device='cpu'):
...
def experiment_learning_rates():
    ...
    # Load dataset
    dataset = ExperimentalTraceDataset('dataset.json', INPUT_SIZE, preprocessing='zscore')
...
def experiment_batch_sizes():
    ...
    for batch_size in batch_sizes:
        ...
        # Train model
        metrics = train_model_experiment(model, train_loader, test_loader, optimal_lr, epochs=25, device=device)
...
def experiment_preprocessing():
    ...
    for preprocessing in preprocessing_methods:
        ...
        dataset = ExperimentalTraceDataset('dataset.json', INPUT_SIZE, preprocessing=preprocessing)
...
def experiment_data_augmentation():
    ...
    for augment in [False, True]:
        ...
        # Load dataset
        dataset = ExperimentalTraceDataset('dataset.json', INPUT_SIZE, 
        ...
        # Train model
        metrics = train_model_experiment(model, train_loader, test_loader, optimal_lr, epochs=30, device=device)
