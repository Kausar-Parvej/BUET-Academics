...
void display()
{
    ...
    glRotatef(baseRotateAngele, 0.0f, 1.0f, 0.0f); // Rotate the base around the Y-axis

    drawBase(base[0], base[1], base[2], base[3], base[4], base[5], base[6], base[7]);

    glPushMatrix();
    glTranslatef(0.0, 0.2, 0.0);
    drawPole(pole[0], pole[1], pole[2], pole[3], pole[4], pole[5], pole[6], pole[7]);

    glTranslatef(pole[0].x, (pole[0].y+pole[3].y)/2, 0.0);
