...
class InceptionBlock(nn.Module):
    def __init__(self, in_channels):
        ...
        self.b1_conv1 = nn.Conv2d(in_channels, 32, kernel_size=1, padding=0, stride=1)
        ...
        # TODO: define 1×1 conv 
        self.b2_conv1 = nn.Conv2d(in_channels, 32, kernel_size=1, padding=0, stride=1)

        # TODO: define 3×3 conv 
        self.b2_conv2 = nn.Conv2d(32, 64, kernel_size=3, padding=1, stride=1) # 128 = 32+64+16+16
        ...
        # TODO: define 1×1 conv
        self.b3_conv1 = nn.Conv2d(in_channels, 32, kernel_size=1, padding=0, stride=1)

        # TODO: define 5×5 conv 
        self.b3_conv2 = nn.Conv2d(32, 16, kernel_size=5, padding=2, stride=1)
        ...
        # TODO: define maxpool 
        self.b4_p1 = nn.MaxPool2d(kernel_size=3,stride=1,padding=1)

        # TODO: define 1×1 conv 
        self.b4_conv1 = nn.Conv2d(64,16,kernel_size=1,padding=0,stride=1)
...
class MiniInceptionNet(nn.Module):
    def __init__(self):
        ...
        self.stem = nn.Sequential(
            nn.Conv2d(3, 64, kernel_size=8, padding=0, stride=2),
            nn.ReLU(),
